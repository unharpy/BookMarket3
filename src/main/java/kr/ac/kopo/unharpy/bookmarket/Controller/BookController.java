...
public class BookController {
    ...
    @GetMapping("/download")
    public void downlaodBookImage(@RequestParam("file") String paramKey, HttpServletResponse response) throws IOException {
        File imageFile = new File(fileDir + paramKey);
        response.setContentType("application/donwload");
